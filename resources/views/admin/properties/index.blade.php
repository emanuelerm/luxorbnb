                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                                <a href="{{ route('admin.properties.show', ['property' => $property->slug]) }}" class="btn btn-primary text-white mb-2">
                                                    <i class="fa-regular fa-eye me-1"></i>
                                                </a>
                                                <a href="{{ route('admin.properties.edit', ['property' => $property->slug]) }}" class="btn btn-warning text-white mb-2">
