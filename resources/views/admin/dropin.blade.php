                            ...
                            <div class="d-flex">
                                <div class="col-lg-3 col-md-3 pt-3">
                                    ...
                                    <p class="text-white">Seleziona i tuoi appartamenti da sponsorizzare *</p>
                                        <div class="cust overflow-y-auto">
                                        @foreach ($properties as $property)
                                            <div class="card mb-3 d-flex flex-nowrap flex-row position-relative">
                                                ...
                                                <input type="checkbox" name="properties_to_sponsor[]" value="{{ $property->id }}" class="position-absolute check-delete">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                            ...
                                            <div class="card col-4 {{ $offerData[$offer->name]['class'] }}">
                                                ...
                                                <div class="card-body pt-2">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="radio" name="selected_offer" id="offer_{{ $index }}" value="{{ $offer->id }}">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
